...
// Pricing tiers — no dollar amounts in v1.
// Prices are admin-managed via Supabase `subscription_plans` table.
// When a price is set in Supabase, it auto-reflects here — no code changes needed.
const PLANS = [
  {
    id: 'explorer',
    name: 'Explorer',
    ...
    highlights: [
      'Country names, regions & GDP overview',
      'Signal labels (High Growth, Emerging, etc.)',
      'Top 5 signal feed per region',
      'Intelligence map — 54 African nations',
      'Caribbean overview',
    ],
  ...
  },
  {
    ...
    badge: 'Most Popular',
    badgeColor: '#2563EB',
    description: 'Full macro data, sector intelligence, and expanded signal feeds for active analysts.',
    highlights: [
      'Everything in Explorer',
      'Inflation & Debt/GDP metrics',
      'Sector scores & drilldown cards',
      'Signal feed expansion to 10 markets',
      'GDP forecast data (partial)',
      'Trade summary (partial)',
      'Country compare engine',
    ],
    cta: 'View Professional Plan',
  ...
  },
  {
    ...
    badge: 'Recommended',
    badgeColor: '#F59E0B',
    description: 'Full forecasts, trade data, and downloadable country reports for investment teams.',
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Full API access (bulk + country-full)',
      'White-label data feeds',
      'Investor memos & briefs',
      'Scoring logic & methodology',
      'Dedicated account support',
    ],
    cta: 'Contact for Demo',
    ctaHref: 'https://afdec-nc.vercel.app/contact',
    ctaStyle: 'ghost',
    featured: false,
  },
];
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 mb-10">
          {PLANS.map((plan) => (
            <div
              key={plan.id}
              className="rounded-sm flex flex-col relative overflow-hidden transition-all duration-300"
              style={{
            ...
            >
              ...
              <div className="px-6 pt-7 pb-5" style={{ borderBottom: '1px solid #1F2A37' }}>
                ...
                {/* Price placeholder — admin managed via Supabase */}
                <div className="mb-4">
                  <div className="text-[11px] font-mono leading-relaxed" style={{ color: '#6B7280' }}>
                    Pricing available on request.<br />
                    <Link href="/subscriptions" className="hover:text-souvera-blue transition-colors underline underline-offset-2" style={{ color: '#9CA3AF' }}>
