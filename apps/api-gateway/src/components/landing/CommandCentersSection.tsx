...
const COMMAND_CENTERS = [
  {
    ...
    subtitle: 'Intelligence for 54 Sovereign Nations',
    description: 'Real-time macroeconomic signaling, investment-grade country profiles, and sector intelligence across the entire African continent.',
    href: '/terminal/africa',
    accentColor: '#22C55E',
    metrics: [
      { label: 'Nations Indexed', value: '54' },
      { label: 'GDP Coverage', value: '$3.1T' },
      { label: 'Sectors', value: '6' },
      { label: 'Signal Engine', value: 'Live' },
    ],
    dashboards: ['Africa Overview', 'Intelligence Map', 'Top 10 Economies', 'Sector Intelligence'],
    cta: 'Open Africa Terminal',
  },
  {
    id: 'caribbean',
    title: 'Caribbean Command',
    subtitle: 'Intelligence for 15 Island Economies',
    description: 'Caribbean economic intelligence covering tourism, energy, financial services, and CARICOM trade flows — powered by the same sovereign-grade infrastructure.',
    href: '/terminal/caribbean',
    accentColor: '#06B6D4',
    metrics: [
    ...
    dashboards: ['Caribbean Overview', 'Intelligence Map', 'Top 10 Economies', 'Sector Intelligence'],
    cta: 'Open Caribbean Terminal',
  },
];
