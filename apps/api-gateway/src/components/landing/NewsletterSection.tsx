        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-[15px] leading-relaxed mb-8" style={{ color: '#9CA3AF' }}>
              Join analysts, investors, and government advisors using Souvera to monitor Africa and Caribbean market intelligence in real time.
            </p>
            <Link
              href="/subscriptions"
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3.5 text-[13px] text-white placeholder-zinc-600 focus:outline-none transition-colors"
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 font-bold text-[11px] tracking-widest uppercase transition-all"
                    style={{ background: '#2563EB', color: 'white' }}
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#1d4ed8'; }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = '#2563EB'; }}
                  >
