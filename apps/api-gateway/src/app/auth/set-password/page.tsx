...
import { Lock, Loader2, CheckCircle2, AlertCircle, Eye, EyeOff, UserPlus } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {status === 'success' ? (
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-white mb-3">Welcome to Souvera</h1>
            <p className="text-zinc-400">
              Your account is now active. Redirecting to the Intelligence Terminal...
            </p>
          </div>
        ) : (
          <>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full mb-6">
              ...
              <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wider">Account Setup</span>
            </div>

            <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Complete Your Account.</h1>
            <p className="text-zinc-500 text-sm font-medium mb-2">
              Set a secure password to access the Souvera Intelligence Terminal.
            </p>
            {userEmail && (
              <p className="text-zinc-400 text-sm mb-8">
                Signing in as <span className="text-white">{userEmail}</span>
              </p>
            )}
            ...
            <p className="mt-8 text-xs text-zinc-600 text-center">
              By completing setup, you agree to the Souvera{' '}
              <Link href="/legal/terms" className="text-blue-500 hover:text-blue-400">Terms of Service</Link>
              {' '}and{' '}
              <Link href="/legal/privacy" className="text-blue-500 hover:text-blue-400">Privacy Policy</Link>.
            </p>
          </>
        )}
      </div>
