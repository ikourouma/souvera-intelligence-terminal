...
import { fetchPublishedNews } from '@/lib/curated-news/public';

export const metadata: Metadata = {
  title: 'News | Souvera Insights',
  description:
    'Souvera-curated market intelligence across African and Caribbean economies — source-attributed editorial coverage.',
  alternates: {
    canonical: 'https://souvera.vercel.app/insights/news',
  },
};

export const dynamic = 'force-dynamic';

export default async function InsightsNewsPage() {
  const articles = await fetchPublishedNews({ limit: 30 });
      ...
      <div className="pt-12 px-4 md:px-8 max-w-[1200px] mx-auto pb-24">
        ...
        <header className="border-b border-zinc-800 pb-6 mb-8">
          <div className="flex flex-wrap items-center gap-3 mb-2">
            <h1 className="text-2xl font-bold tracking-tighter">Souvera News</h1>
          ...
          <p className="text-sm text-zinc-400 max-w-2xl">
            Editorial intelligence aggregated across African and Caribbean markets. Every story
            includes referenced sources — distinct from automated country News Pulse in the
